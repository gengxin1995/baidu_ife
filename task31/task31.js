function radioChange() {
    if (document.getElementById("inRadio").checked) {
        document.querySelector(".in").className = "in";
        document.querySelector(".out").className = "out hide";
    } else {
        document.querySelector(".in").className = "in hide";
        document.querySelector(".out").className = "out";
    }
}
