...
function addBtnHandle() {
    addAqiData();
    renderAqiList();
    var strCity = document.getElementById("aqi-city-input");
    var strAqi = document.getElementById("aqi-value-input");
    strCity.value = "";
    strAqi.value = "";
}
...
function init() {
    ...
    var table = document.getElementById("aqi-table");
    var btnDel = table.getElementsByClassName("del-btn");
